...
def disable_voting_backbone_training(network:VoteNet):
    for param in network.backbone_net.parameters():
        param.requires_grad = False
    for param in network.vgen.parameters():
        param.requires_grad = False
...
def train_only_proposal_module(start_epoch):
    global EPOCH_CNT 
    min_loss = 1e10
    loss = 0
...
if __name__=='__main__':
    train_only_proposal_module(start_epoch)
